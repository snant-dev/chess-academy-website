...
export const HeroSection = ({ carrouselImages }) => {
    const [indexImage, setIndexImage] = useState(Math.floor(Math.random() * carrouselImages.length));
                    ...
                    <div className="grid grid-cols-12 h-full content-center">
                        <div className="col-start-3 col-end-9 xl:col-end-8 text-white">
                            <h1 className="text-4xl lg:text-5xl xl:text-6xl mb-4">
                                Academia de Ajedrez "Domina el Tablero"
                            </h1>
                            <p className="mb-6 lg:text-lg">
                                Desarrolla tu genio estratégico desde cualquier
                                lugar del mundo con nuestras lecciones
                                magistrales y entrenamiento personalizado.
                            </p>
